...
public class AccountCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3512063125405225648L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AccountCreatedEvent\",\"namespace\":\"com.khalanirek.stockmarket.avro.account\",\"fields\":[{\"name\":\"accountId\",\"type\":\"string\"},{\"name\":\"ownerId\",\"type\":\"string\"}]}");
  ...
  private java.lang.CharSequence ownerId;
   ...
   */
  public AccountCreatedEvent(java.lang.CharSequence accountId, java.lang.CharSequence ownerId) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: ownerId = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder newBuilder() {
    return new com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder();
  }
   ...
   * @return A new AccountCreatedEvent RecordBuilder
   */
  public static com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder newBuilder(com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder other) {
    if (other == null) {
      return new com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder();
    } else {
      return new com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new AccountCreatedEvent RecordBuilder
   */
  public static com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder newBuilder(com.khalanirek.stockmarket.avro.account.AccountCreatedEvent other) {
    if (other == null) {
      return new com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder();
    } else {
      return new com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccountCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.khalanirek.stockmarket.avro.account.AccountCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.accountId)) {
        this.accountId = data().deepCopy(fields()[0].schema(), other.accountId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder setAccountId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder clearAccountId() {
      accountId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder setOwnerId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.khalanirek.stockmarket.avro.account.AccountCreatedEvent.Builder clearOwnerId() {
      ownerId = null;
    ...
    public AccountCreatedEvent build() {
      try {
        ...
        record.ownerId = fieldSetFlags()[1] ? this.ownerId : (java.lang.CharSequence) defaultValue(fields()[1]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.ownerId = in.readString(this.ownerId instanceof Utf8 ? (Utf8)this.ownerId : null);
